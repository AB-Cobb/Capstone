export class Team_member {
    ...
    constructor(name : string, email : string, phone : string, gender : string, wieght : number, hieght : number, side_preference : string, active : boolean, emergency_cont : string = null, id : number = null) {
        this.id = id;
        this.name =name;
        this.email = email;
        this.phone = phone;
